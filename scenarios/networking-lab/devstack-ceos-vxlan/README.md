# Devstack with Arista cEOS VXLAN Spine-and-Leaf

Spine-and-leaf topology with 4 Arista cEOS switches, 1 Devstack node, 2 Ironic nodes, and 1 controller.
...
- Leafs: Route reflector clients, Vxlan1 VTEP (source Loopback0)
- ML2 dynamically manages VLANs/VNIs

## Deployment

```bash
ansible-playbook -e @scenarios/networking-lab/devstack-ceos-vxlan/bootstrap_vars.yml -e os_cloud=<cloud-name> bootstrap_devstack.yml
```
